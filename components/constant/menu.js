export const MENUITEMS = [
   // {
   //    path: '/layouts/Furniture', title: 'Vouchers', type: 'link'
   //    // children: [
   //    //    {
   ...
   //       },
         ...
         { path: '/page/terms-and-conditions', title: 'Terms and Conditions', type: 'link' },

         { path: '/page/search', title: 'Privacy Policy', type: 'link' },
   //       { path: '/page/typography', title: 'typography', type: 'link', tag: 'new' },
         { path: '/page/review', title: 'Return and Refund Policy', type: 'link' },
   ...
   //       { path: '/page/coming-soon', title: 'coming-soon', type: 'link' },
         { path: '/page/faq', title: 'FAQs', type: 'link' },
   //    ]
   // },
   // {
