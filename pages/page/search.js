  ...
  return (
    <CommonLayout parent="home" title="Privacy Policy">
      ...
      <div class="entry-content" style={{margin:'20px 100px'}}>
        ...
        <p>Our website address is: https://www.shiningvouch.com.</p>

        <h2 class="wp-block-heading">Comments</h2>

        <p>
          <strong class="privacy-policy-tutorial">Suggested text: </strong>When
        ...
        <p>
          <strong class="privacy-policy-tutorial">Suggested text: </strong>If
        ...
        <p>
          <strong class="privacy-policy-tutorial">Suggested text: </strong>If
          you request a password reset, your IP address will be included in the
          reset email.
        </p>
